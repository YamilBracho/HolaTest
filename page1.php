<?php 
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'logout')
     {
        ...
        header("Location: http://localhost/holatest/login.php", true, 301);
        exit();
    }
    ...
    if ($currentUser->role != ROLE_ADMIN && $currentUser->role != ROLE_PAGE_1) {
...
<body>
 <p>Hello 1 <?php echo $currentUser->name ?></p>
 <a href="page1.php?action=logout">Logout</a>
